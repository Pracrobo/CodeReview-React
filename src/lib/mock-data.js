...
export const mockAnalyzingRepositories = [
  {
    ...
    estimatedCompletion: '2025-05-20T11:15:00Z',
  },
  {
    id: '5',
    name: 'react',
    ...
    progress: 30,
    startedAt: '2025-05-20T10:45:00Z',
    estimatedCompletion: '2025-05-20T11:30:00Z',
  },
];
...
export const mockIssueDetails = {
  ...
  aiAnalysis: {
    ...
    suggestion:
      '이 문제를 해결하기 위해서는 Next.js 13 앱 라우터에서  지시문을 사용하여 클라이언트 컴포넌트를 명시적으로 선언하고, 그 안에서 useQuery를 사용해야 합니다. 또는 서버 컴포넌트에서 사용할 수 있는 별도의 데이터 페칭 API를 개발하는 것이 좋을 것 같습니다.',
  },
};
